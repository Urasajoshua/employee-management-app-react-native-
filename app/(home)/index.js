        ...
        <ScrollView>
            <LinearGradient colors={['#7F7FD5', '#E9E4F0']} style={{ flex: 1 }}>
                <View style={{ padding: 12 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20, alignItems: 'center', gap: 20 }}>
                        <Pressable style={{ backgroundColor: '#D3CCE3', flex: 1, padding: 12, borderRadius: 6, alignItems: 'center', justifyContent: 'center' }}>
                            <View style={{ width: 50, height: 50, borderRadius: 25, backgroundColor: 'white', alignItems: 'center', justifyContent: 'center' }}>
                                <Ionicons name="people-sharp" size={24} color="black" />
                            </View>
                            <Text style={{ marginTop: 7, fontWeight: '600' }}>Employee Lists</Text>
                        </Pressable>
                    ...
                    <View style={{ marginTop: 20, backgroundColor: 'white', paddingHorizontal: 10, paddingVertical: 10, borderRadius: 7 }}>
                        <Pressable style={{ backgroundColor: '#BE93C5', borderRadius: 7, padding: 10, flexDirection: 'row', alignItems: 'center', marginVertical: 10 }}>
                    ...
                    <View style={{marginTop:20,flexDirection:'row',alignItems:'center',gap:12 }}>
                        <View style={{backgroundColor:'#f79d00',flex:1,borderRadius:6,padding:12,alignItems:'center',justifyContent:'center'}}>
                            <View style={{width:35,height:35,borderRadius:7,backgroundColor:'white',alignItems:'center',justifyContent:'center'}}>
                        ...
                        <View style={{backgroundColor:'#ABCABA',flex:1,borderRadius:6,padding:12,alignItems:'center',justifyContent:'center'}}>
                            <View style={{width:35,height:35,borderRadius:7,backgroundColor:'white',alignItems:'center',justifyContent:'center'}}>
                            <Feather name="bar-chart" size={24} color="black" />
                            </View>
